...
class profile_model {
    ...
    public function select_values($arrArgument) {
        return $this->bll->select_values_BLL($arrArgument);
    }
    ...
    public function select_list_shop_user($arrArgument){
        return $this->bll->select_list_shop_user_BLL($arrArgument);
    }
